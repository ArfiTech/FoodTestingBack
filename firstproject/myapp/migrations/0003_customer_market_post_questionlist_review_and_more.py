# Generated by Django 4.1 on 2022-10-02 06:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myapp', '0002_departments_employees'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Market',
            fields=[
                ('reg_num', models.CharField(max_length=12, primary_key=True, serialize=False)),
                ...
                ('congestion_degree', models.CharField(blank=True, max_length=45, null=True)),
            ],
            options={
                'db_table': 'market',
                'managed': False,
        ...
        migrations.CreateModel(
            name='Post',
            fields=[
                ('post_uuid', models.CharField(max_length=36, primary_key=True, serialize=False)),
                ...
                ('fast_response', models.CharField(blank=True, max_length=200, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='Questionlist',
            fields=[
                ('ques_uuid', models.CharField(max_length=36, primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='Review',
            fields=[
                ('review_uuid', models.CharField(max_length=36, primary_key=True, serialize=False)),
